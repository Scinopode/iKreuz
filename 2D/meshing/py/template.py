...
gmsh.model.geo.addPoint(r2, 0, 0, lc, 2) # Auxiliary points for the boundary
gmsh.model.geo.addPoint( 0,r2, 0, lc, 3)
gmsh.model.geo.addPoint( 0,r1, 0, lc, 4) # Auxiliary points for the boundary
